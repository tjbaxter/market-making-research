...
with col2:
    ...
    with st.expander("⚠️ Experiment 4: Failure Analysis"):
        st.markdown("""
...
with col3:
    ...
    - Novel regime-switching application
...
4. **⚠️ Failure Analysis** - Edge cases, limitations, and mitigation strategies
5. **🎮 Live Simulator** - Interactive strategy testing with real-time visualization
""")

render_info_box(
    "💡 **Pro Tip**: Start with PnL Decomposition to understand the problem, "
